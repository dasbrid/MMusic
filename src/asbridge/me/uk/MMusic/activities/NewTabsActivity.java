...
*/
        ...
        tabsAdapter = new NewTabsAdapter(getSupportFragmentManager(),this);
    ...
    private void updatePlayQueue() {
        ...
        if (retainFragment.serviceReference != null) {
            ...
            PlayQueueFragment pqf = (PlayQueueFragment)tabsAdapter.getCurrentFragment();//(PlayQueueFragment)getSupportFragmentManager().findFragmentById(R.id.fragment_playqueue);
